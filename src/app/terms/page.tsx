...
export const metadata = {
  title: 'Terms of Service - TrueSignal',
  description: 'Terms and conditions for using TrueSignal.',
};
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="space-y-8 text-sm text-zinc-400 leading-relaxed">
          <section>
            ...
            <p>
              By creating an account or using TrueSignal (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the Service. We may update these terms from time to time, and continued use constitutes acceptance of any changes.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">2. Account Registration</h2>
            <p className="mb-3">To use TrueSignal, you must create an account. You agree to:</p>
          ...
          <section>
            ...
            <p className="mb-3">TrueSignal operates on a credit-based system:</p>
            <ul className="list-disc list-inside space-y-1.5 text-zinc-500">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1.5 text-zinc-500">
              ...
              <li>Resell, redistribute, or commercially share raw data obtained from TrueSignal</li>
          ...
          <section>
            ...
            <p>
              TrueSignal, its logo, design, features, and all related content are the intellectual property of TrueSignal and are protected by copyright, trademark, and other laws. You may use search results for your own business purposes (e.g., outreach, analysis) but may not claim ownership of the Service itself or its underlying technology.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              TrueSignal provides data sourced from publicly available Google Business Profiles. While we strive for accuracy:
            </p>
            <ul className="list-disc list-inside space-y-1.5 text-zinc-500">
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, TrueSignal and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the Service. Our total liability for any claims shall not exceed the amount you paid to us in the 12 months preceding the claim.
            </p>
          </section>
